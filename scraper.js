...
// ScraperAPI configuration (optional - falls back to direct if not set)
...
async function scrapeAmazon(url) {
  try {
    ...
    const scraperApiUrl = getScraperApiUrl(url);
    let data;
    ...
    if (scraperApiUrl) {
      ...
      console.log('Using direct connection (no ScraperAPI key)...');
